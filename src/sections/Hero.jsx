    ...
    <section id="home" className="relative min-h-screen bg-navy-900 flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-32 md:py-40 w-full">
        <div className="max-w-4xl">
          ...
          >
            Connecting{' '}
            <span className="gradient-text">Global Buyers</span>
            {' '}With Premium{' '}
            <span className="text-gold-500">Wholesale</span>
            {' '}Products
          </motion.h1>
          ...
          >
            Trusted Export Partner for Bulk Orders Worldwide — Agriculture, Spices, Textiles, Handicrafts & More.
          </motion.p>
