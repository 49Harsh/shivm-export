...
const CATEGORIES = ['Agriculture', 'Spices & Herbs', 'Food Products', 'Textiles', 'Handicrafts', 'Home Decor', 'Industrial Goods'];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/40 text-sm leading-relaxed mb-6">
              India's trusted B2B wholesale export company. Connecting global buyers with premium Indian products since 2014.
            </p>

            {/* Certifications */}
            <div className="flex flex-wrap gap-2 mb-6">
              {['APEDA', 'ISO 9001', 'Spice Board', 'FSSAI'].map(cert => (
