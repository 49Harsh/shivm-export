...
const VALUES = [
  { icon: '🎯', title: 'Mission', desc: 'To make premium Indian girls\' clothing accessible to global wholesale buyers through transparent, reliable, and efficient export services.' },
  { icon: '🌟', title: 'Vision', desc: 'To be recognized as India\'s most trusted girls\' clothing export company, serving buyers across 150+ countries by 2030.' },
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-500 dark:text-white/60 text-base leading-relaxed mb-6">
              Founded in 2014, ShivM Export began as a small garment trading company in Delhi. Over a decade, we've grown into a specialized wholesale exporter focused exclusively on girls' clothing — dresses, ethnic wear, tops, party wear, and more.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                { icon: '🔰', label: 'Registered Apparel Exporter' },
